                ...
                <form name="myform-select" method="GET" class="form-inline">
                    <div class="form-group select-input">
                        ...
                        <div class="input-group">
                            ...
                            {{From::select(m('Menu')->status_arr,request('status'),'class="form-control" name="status"','--请选择--')}}
                        </div>

                        <div class="input-group">
                            <div class="input-group-addon">状态</div>
                            {{From::select(m('Menu')->write_log_arr,request('write_log'),'class="form-control" name="write_log"','--请选择--')}}
                        </div>
                    ...
                    <div class="col-xs-12">
                        <table id="simple-table" class="table  table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>{{m('Menu')->status_arr[$info['status']]}}</td>
                                <td>{{m('Menu')->write_log_arr[$info['write_log']]}}</td>
                                <td>
