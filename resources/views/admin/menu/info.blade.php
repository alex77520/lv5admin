            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{isset($info->id)?'edit':'add'}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! From::radio(m('Menu')->status_arr,!empty($info->status)?$info->status:1,' name="status" ',70,'status') !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! From::radio(m('Menu')->write_log_arr,!empty($info->write_log)?$info->write_log:2,' name="write_log" ',70,'write_log') !!}
                        </div>
                    </div>
