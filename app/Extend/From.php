...
class From
{
     ...
     * 下拉选择框
     */
    public function select($array = array(), $id = 0, $str = '', $default_option = '',$select2_name='')
    {
        $string = '<select ' . $str . '>';
     ...
     * @return string
     */
    public function checkbox($array = array(), $id = '', $str = '', $defaultvalue = '', $width = 5, $field = '')
    {
        $string = '';
        $id = trim($id);
        if ($id != '')
     ...
     * @param $str 属性
     */
    public function radio($array = array(), $id = 0, $str = '', $width = 1, $field = '')
    {
        $string = '';
        foreach ($array as $key => $value) {
