...
trait JumpAdmin {
	...
	//dd($url);
	return redirect('/admin/msg/publicIndex')->with(['msg' => $msg, 'url' => $url, 'wait' => $wait, 'code' => 1]);
    }
	...
	return redirect('/admin/msg/publicIndex')->with(['msg' => $msg, 'url' => $url, 'wait' => $wait, 'code' =>0]);
    }
